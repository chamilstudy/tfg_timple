...
export const manualData = [
  ...
  {
    title: "Publicaciones", // Nombre visible de la sección
    slug: "publication", // Slug para la URL → params.section
    articles: [
      {
        title: "Cómo utilizar las publicaciones", // Título del artículo
        slug: "introduccion-publications", // Slug para la URL → params.article
        description: "Introducción a las publicaciones",
        children: <></>,
      },
      {
        title: "Crear una publicacion", // Título del artículo
        slug: "create-publication", // Slug para la URL → params.article
        description: "Pasos para crear una publicación",
        children: (
          <>
            <p>
              Puedes <span className="font-bold">crear una publicación</span>{" "}
              utilizando del botón <span className="font-bold">crear</span> de
              la cabercera de la página y desde tu perfil través del botón{" "}
              <span className="font-bold">publicar</span> sobre tu lista de
              publicaciones.
            </p>
          </>
        ),
      ...
      {
        title: "Editar una publicacion", // Título del artículo
        slug: "edit-publication", // Slug para la URL → params.article
        description: "Pasos para editar una publicación",
        children: <></>,
      },
      {
        title: "Eliminar una publicacion", // Título del artículo
        slug: "delete-publication", // Slug para la URL → params.article
        description: "Pasos para eliminar una publicación",
        children: <></>,
      },
      {
        title: "Ver mis publicaciones", // Título del artículo
        slug: "view-own-publications", // Slug para la URL → params.article
        description: "Pasos para ver mis publicaciones",
        children: <></>,
      },
    ],
  },
  {
    title: "Solicitudes", // Nombre visible de la sección
    slug: "request", // Slug para la URL → params.section
    articles: [
      {
        title: "Cómo utilizar las solicitudes", // Título del artículo
        slug: "introduccion-request", // Slug para la URL → params.article
        description: "Introducción a las solicitudes",
        children: <></>,
      },
      {
        title: "Crear una solicitud", // Título del artículo
        slug: "create-request", // Slug para la URL → params.article
        description: "Pasos para crear una solicitud",
        children: <></>,
      },

      {
        title: "Eliminar una solicitud", // Título del artículo
        slug: "delete-request", // Slug para la URL → params.article
        description: "Pasos para eliminar una solicitud",
        children: <></>,
      },
      {
        title: "Ver mis solicitudes", // Título del artículo
        slug: "view-own-requests", // Slug para la URL → params.article
        description: "Pasos para ver mis solicitudes",
        children: <></>,
      },
      {
        title: "Ver solicitudes de otros usuarios", // Título del artículo
        slug: "view-other-requests", // Slug para la URL → params.article
        description: "Pasos para ver solicitudes de otros usuarios",
        children: <></>,
      },
      {
        title: "Resolver una solicitud", // Título del artículo
        slug: "resolve-request", // Slug para la URL → params.article
        description: "Pasos para ver resolver una solicitud",
        children: <></>,
      },
    ],
  },
